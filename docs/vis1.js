...
function hexagonPoints(x, y, size) {
  ...
  for (var i = 0; i <= 6; i++) {
    ...
    points.push(
      (x + size * Math.cos(angle_rad)).toFixed(2) +
        "," +
        (y + size * Math.sin(angle_rad)).toFixed(2)
    );
  }
  return points.join(" ");
}
...
function redrawCourt() {
  ...
  svg
    ...
    .attr(
      "d",
      "M 338.66,58.11 V 221.24 H 202.6 V 58.11 h 136.06 m 1.41,-1.42 H 201.19 V 222.66 H 340.08 V 56.69 Z"
    )
    .style("fill", "#000000");
  svg
    .append("path")
    .attr(
      "d",
      "m 321.64,222.66 h -1.41 c -0.37,27.05 -22.48,48.94 -49.6,48.94 -27.12,0 -49.23,-21.89 -49.6,-48.94 h -1.41 c 0.37,27.87 23.06,50.36 51.01,50.36 27.95,0 50.64,-22.49 51.01,-50.36 z"
    )
    .style("fill", "#000000");
  svg
    .append("rect")
  ...
  svg
    ...
    .attr(
      "d",
      "m 307.47,102.79 h -1.42 c -0.37,19.23 -16.11,34.76 -35.42,34.76 -19.31,0 -35.05,-15.53 -35.42,-34.76 h -1.42 c 0.37,20.05 16.72,36.18 36.84,36.18 20.12,0 36.47,-16.13 36.84,-36.18 z"
    )
    .style("fill", "#000000");
  svg
    .append("rect")
